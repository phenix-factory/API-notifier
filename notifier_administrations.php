<?php
/**
 * Fichier gérant l'installation et désinstallation du plugin API Notifier
 *
 * @plugin     API Notifier
 * @copyright  2014
 * @author     Phenix
 * @licence    GNU/GPL
 * @package    SPIP\Notifier\Installation
 */
...
/**
 * Fonction d'installation et de mise à jour du plugin API Notifier.
 *
 * Vous pouvez :
 *
 ...
 * @return void
**/
function notifier_upgrade($nom_meta_base_version, $version_cible) {
	$maj = array();
	# quelques exemples
	...
	#	array('ecrire_config', array('notifier', array('exemple' => "Texte de l'exemple")))
	#);
	#
...
/**
 * Fonction de désinstallation du plugin API Notifier.
 *
 * Vous devez :
 *
 ...
 * @return void
**/
function notifier_vider_tables($nom_meta_base_version) {
	# quelques exemples
	# (que vous pouvez supprimer !)
